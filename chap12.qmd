...
## Multiplicative Intensity Models (I)
...
obj01 <- coxph(
  Surv(start, stop, status) ~ hormone + meno + agec + size + nodes + prog + 
    estrg + strata(grade),
  data   = gbc_ms,
  subset = (from == 0 & to == 1)
)
...
## Multiplicative Intensity Models (II)
::: fragment
-   **Three (semi-Markov) models**
