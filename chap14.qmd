...
-   **Weight construction**
    ...
    -   **Stablized IPTW-IPCW weights** \begin{equation}\label{eq:causal:swights}
        ...
        \end{equation}
        -   $\pi_{a}(V)=\pr(A=a\mid V)$ and $G_{a}(t\mid V)=\pr(C\geq t\mid A=a, V)$
...
-   **Notation**
    ...
    -   Discrete time points: $0=t_0<t_1<\cdots<t_m$
...
![](images/causal_tm_dag.png){fig-align="center" width="70%"}
:::
...
-   **Point/time-varying treatment/confounding**
    -   Causal inference: what if (Hernan and Robins, 2024)
        -   G-methods: MSM, g-formula (standardization), g-estimation (structural nested models)
...
-   **Marginal structural model (MSM)** \begin{equation}
        \lambda_{\overline a}(t\mid V)=\exp\{\beta a(t)+\gamma^{\rm T}V\}
        \end{equation} ![](images/causal_tm_dag.png){fig-align="center" width="70%"}
