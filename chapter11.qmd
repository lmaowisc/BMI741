...
# ranef(obj_joint)  # Extract random effects
...
obj_valve <- jm(
  ...
  time_var        = "obsyear",   # specify time variable for longitudinal models
  functional_forms= fForms       # specify functional forms of biomarkers in survival model
)
summary(obj_valve)
