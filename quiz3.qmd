...
-   Calculate the (Nelsen--Aalen-type) estimates of the **average number of infections per patient by
month 2, 4, and 6**.\vspace{2cm}
...
Let $N^*(t)$ denote the average number of recurrent events by time $t$ (such as estimated in Question 1). Let $Z=1, 0$ denote treatment and control groups, respectively.
Under the multiplicative mean model:
$$
E\{N^*(t) \mid Z\} = \exp(\beta Z)\mu_0(t),
$$

-   What is the mean function in each group, i.e., $E\{N^*(t) \mid Z = z\}$ for $z= 1, 0$?\vspace{2cm}
