...
-   What have we learned (and future directions)?
    -   Background
...
-   **Formula** **(Ch 6)**
    -   R-programs available (`npsurvSS` package) $$
...
-   **Key feature** **(Ch 8 & 9)**
    ...
    - **Three scenarios**
        1. Same regression parameter; same baseline function
        2. Same regression parameter; different baseline functions
        3. Different regression parameters; different baseline functions
...
-   **Regularized Cox model** **(Ch 15)**
    -   Penalize log-partial likelihood by $L_1$/$L_2$-norm of $\beta$
...
-   Book manuscript to be published by Springer soon
