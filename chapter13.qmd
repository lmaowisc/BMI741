...
## Notes
# Proportional means model for HF-ACTION
library(Wcompo)
library(rmt)
data(hfaction) # Load data
...
obj <- CompoML(hfaction$patid, hfaction$time, hfaction$status, 
                  hfaction[, c("trt_ab", "age60")], w = c(2, 1))
obj
#> Call:
#> CompoML(id = hfaction$patid, time = hfaction$time, status = hfaction$status, 
#>     Z = hfaction[, c("trt_ab", "age60")], w = c(2, 1))
#> 
...
#> 
#> 
#> Newton-Raphson algorithm converges in 2 iterations.
#> 
#> Estimates for Regression parameters:
#> 
#>        Estimate       se z.value  p.value   
#> trt_ab -0.17748  0.11073 -1.6027 0.108991   
#> age60  -0.33217  0.10226 -3.2483 0.001161 **
#> ---
...
#> trt_ab  0.8373789    0.6740079     1.0403490
#> age60   0.7173676    0.5870824     0.8765656
```
