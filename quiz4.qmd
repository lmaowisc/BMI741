---
title: "10-Minute In-Class Quiz 4: Survival Analysis (Chapter 12)"
format: pdf
header-includes:
  - \usepackage{tikz}
...
In a study of patients with chronic liver disease, individuals are initially diagnosed with **compensated cirrhosis**, meaning that liver function is impaired but no major clinical symptoms have yet developed. Over time, some patients experience disease progression and develop **decompensated cirrhosis**, characterized by clinical events such as ascites, variceal bleeding, or hepatic encephalopathy.

At any point, patients may undergo a **liver transplant**, either directly from the compensated state or after progressing to decompensation. Finally, patients may **die** after developing decompensated cirrhosis---either without receiving a transplant or following transplantation.

### (a) (5 points)

Draw a multistate diagram that includes the four states---compensated cirrhosis, decompensated cirrhosis, liver transplant, and death---and indicates all possible transitions between them.
