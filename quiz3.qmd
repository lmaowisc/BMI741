...
-   Calculate the (Nelsen--Aalen-type) estimates of the **average number of infections per patient by month 6** (Hint: cumuative sums of number of infections over number at risk).
