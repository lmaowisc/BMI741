...
-   Calculate the (Nelsen--Aalen-type) estimates of the **average number of infections per patient by month 6** (Hint: cumuative sums of number of infections over number at risk). <!-- -   `d_j`: observed number of events $d_j$ --> <!-- -   `n_j`: observed number of patients at risk $n_j$ --> <!-- -   `cum_avg`: $\sum_{l=1}^j d_{l}/n_l$ -->
...
$$
\frac{\mbox{Total number of black dots by month }6}{6 \mbox{ subjects}}
$$
