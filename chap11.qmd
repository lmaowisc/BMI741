...
-   **Model specification** \begin{equation}\label{eq:longit:survival_sub}
    \pr\{t\leq T_i<t+\dd t\mid T_i \geq t, Z_i^*, \overline m_i(t)\}=\exp\{\beta^\T Z_i^*+\nu m_i(t)\}\lambda_0(t)\dd t
    \end{equation}
...
-   **Biomarker effect by baseline group**
    -   Biomarker $\times$ baseline interaction $$
        \pr(t\leq T_i<t+\dd t\mid T_i \geq t, Z_i^*, \overline m_i(t))=\exp\big\{\beta^\T Z_i^*+\nu m_i(t)+ \tilde\nu^\T Z_i^*m_i(t)\big\}\lambda_0(t)\dd t
        $$
:::
...
-   **Effect of biomarker trend (change rate)**
    ...
    -   **Survival sub-model** \begin{equation}\label{eq:longit:survival_sub_rand}
        \pr(t\leq T_i<t+\dd t\mid T_i \geq t, Z_i, b_i)=\exp\{\beta^\T Z_i+\nu_0b_{i0}+\nu_1b_{i1}\}\lambda_0(t)\dd t.
        \end{equation}
...
-   **Multple biomarkers**
    -   **Longitudinal sub-models** $$
        ...
        $$
    -   **Survival sub-model** $$
        \pr\{t\leq T_i<t+\dd t\mid T_i \geq t, Z_i^*, \overline m_{i1}(t), \ldots, \overline m_{iK}(t)\}=\exp\left\{\beta^\T Z_i^*+\sum_k\nu_k m_{ik}(t)\right\}\lambda_0(t)\dd t
        $$
:::
...
-   **Multple events**
    -   **Shared-fraity sub-models** \begin{equation}\label{eq:longit:survival_sub_mult}
        \pr\{t\leq T_{ik}<t+\dd t\mid T_i \geq t, \xi_i, Z_i^*, \overline m_i(t)\}=\xi_i\exp\{\beta_k^\T Z_i^*+\nu_k m_i(t)\}\lambda_{0k}(t)\dd t
        \end{equation}
:::
...
-   **Three longitudinal sub-models** ![](images/longit_hv_long.png){fig-align="center" width="85%"}
