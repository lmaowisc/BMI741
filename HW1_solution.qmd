...
df |> 
  mutate(
    empl = factor(empl, levels = c("ft", "pt", "other"), labels = c("Full-time", "Part-time", "Other")),
    level = factor(level, levels = c("heavy", "light"), labels = c("Heavy", "Light")),
    race = factor(race, levels = c("black", "hispanic", "white", "other"), labels = c("Black", "Hispanic", "White", "Other"))
  ) |> 
  tbl_summary(
  by = trt, # by treatment
