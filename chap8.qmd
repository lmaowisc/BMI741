...
=======
    -   `obj$frail`: estimated $\hat\xi_i$ for each unit
>>>>>>> d08c9a2f03ede495848ffc879b6e2b0265772f88
...
$$
where the effects of $Z_{(1)}$ are component-specific while those 
of $Z_{(2)}$ are component-invariant?
:::
:::
...
-   **Other frailty distributions**
    -   **Log-normal**: `coxph(Surv(time, status) ~ covariates + 
