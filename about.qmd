...
MW 2:30—3:45pm; 1345 HSLC (Health Sciences Learning Center)
...
Po-Kuei Chen (pchen299\@wisc.edu); Office hours: TBD, or by appointment.
...
|      | Reading | Chapter 4                                                                     |
| 2/14 | Lecture | The Cox Proportional Hazards Model – [Extensions and Diagnostics]{.smallcaps} |
|      | Reading | Chapter 4                                                                     |
| 2/19 | Lecture | Other Non- and Semi-parametric Methods                                        |
|      | Reading | Chapter 5                                                                     |
| 2/21 | Lecture | Study Design and Sample Size Calculation                                      |
|      | Reading | Chapter 6                                                                     |
| 2/26 | Lecture | Left Truncation                                                               |
|      | Reading | Chapter 7                                                                     |
| 2/28 | Lecture | Interval Censoring                                                            |
|      | Reading | Chapter 7                                                                     |
...
|      |         |                                                                          |
|-------|---------|--------------------------------------------------------|
| 3/4  | Lecture | Multivariate Events – [Conditional (Frailty) Models]{.smallcaps}         |
|      | Reading | Chapter 8                                                                |
| 3/6  | Lecture | Multivariate Event Times – [Marginal Models]{.smallcaps}                 |
|      | Reading | Chapter 8                                                                |
| 3/11 | Lecture | Recurrent Event                                                          |
|      | Reading | Chapter 9                                                                |
| 3/13 | Lecture | Competing and Semi-competing Risks                                       |
|      | Reading | Chapter 10                                                               |
| 3/18 | Lecture | Joint Analysis of Longitudinal and Survival Data                         |
|      | Reading | Chapter 11                                                               |
| 3/20 | Lecture | Multistate Models – [Introduction]{.smallcaps}                           |
|      | Reading | Chapter 12                                                               |
| 4/1  | Lecture | Multistate Models – [Cox-Type Markov and Semi-Markov Models]{.smallcaps} |
|      | Reading | Chapter 12                                                               |
| 4/3  | Lecture | Composite Endpoints – [Nonparametric Estimation]{.smallcaps}             |
|      | Reading | Chapter 13                                                               |
| 4/8  | Lecture | Composite Endpoints – [Semiparametric Regression]{.smallcaps}            |
|      | Reading | Chapter 13                                                               |
...
|      |         |                                                                  |
|-------|---------|--------------------------------------------------------|
| 4/10 | Lecture | Causal Inference with Censored Data – The Basics                 |
|      | Reading | Chapter 14                                                       |
