...
![](images/cox_cox_snell.png){fig-align="center" width="65%"}
...
![](images/cox_gbc_age_cat.png){fig-align="center" width="60%"}
...
-   **Modeling specification** \begin{equation}\label{eq:cox:time_varying_model}
...
-   **Modeling specification** \begin{equation}\label{eq:cox:time_varying_model_ex}
...
-   **Example**: single baseline covariate $Z_1 = 1, 0$
    ...
    -   Add $Z_2(t) = Z_1 t$, then $\lambda(t\mid Z_1, Z_2)=\exp\{\beta_1Z_1 + \beta_2Z_2(t)\}\lambda_0(t)$ means $$
        \frac{\lambda(t\mid Z_1=1)}{\lambda(t\mid Z_1=0)}=\exp(\beta_1+\beta_2 t)
        $$
