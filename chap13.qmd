...
subtitle: "Chapter 13 - Composite Endpoints"
...
3.  Win ratio: two-sample analysis
...
:::{.fragment}
-   **Progressive process**
    $$Y^{(a)}(t)\leq Y^{(a)}(s) \mbox{ for all } 0\leq t\leq s$$
...
#| echo: false
#| label: tbl-desc
#| tbl-cap: Descriptive statistics for a high-risk subgroup (n=426)  in HF-ACTION trial.
library(rmt)
library(tidyverse)
library(knitr)
...
## Standard Analyses
:::{.fragment}
-   **Traditional composite and overall survival** ![](images/rmt_rmest.png){fig-align="right" width="90%"}
:::
...
:::
:::{.fragment}
![](images/rmt_mut.png){fig-align="center" width="70%"}
:::
...
:::{.fragment}
-   **General WR statistics** 
    \begin{equation}\label{eq:wr:gen_WR}
...
-   **More on RMT-IF**
    -   Mao (2023, [*Biometrics*](https://doi.org/10.1111/biom.13570))
